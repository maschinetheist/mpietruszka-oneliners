...
curl -X GET https://cloudbilling.googleapis.com/v1/services?key="AIzaSyAVElfwe_IIO9B_UksbBj4ZWHXYaRt39Uo" | jq '.services[] | select(.displayName == "Compute Engine")'

## GCE Metadata
# Get service account email
curl --header "Metadata-Flavor: Google" http://169.254.169.254/computeMetadata/v1/instance/service-accounts/default/email
